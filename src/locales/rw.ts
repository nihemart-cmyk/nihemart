export const rw: Record<string, string> = {
   ...
   "checkout.fullNamePlaceholder": "Amazina yose",
   "checkout.errors.fullNameRequired": "Amazina yose ni ngombwa",
   ...
   "payment.method.airtel_money.description":
      "Wishyura ukoresheje Airtel Money",
   "payment.method.airtel_money.badge": "Mobile",

   "payment.method.visa_card.name": "Visa Card",
   "payment.method.visa_card.description":
      "Wishyura ukoresheje ikarita ya Visa",
   ...
   "chatbot.welcome":
      "Muraho! Nakora iki ngo ngufashe kuri NiheMart uyu munsi?",

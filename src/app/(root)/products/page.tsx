                                      ...
                                      <div className="space-y-2">
                                         ...
                                         <div className="space-y-2">
                                            ...
                                            <Button
                                               ...
                                               variant="outline"
                                               className="w-full h-9 text-sm font-medium text-brand-blue border border-brand-blue bg-transparent rounded-md hover:bg-brand-blue hover:text-white transition"
                                            >
                                               {t("products.buyNow")}
                                            </Button>
                                         </div>

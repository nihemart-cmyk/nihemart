                  ...
                  <div className="flex items-center gap-4">
                     ...
                     <div className="flex-1">
                        <Button
                           ...
                           className="w-full h-12 text-base font-medium bg-gradient-to-r from-orange-500 to-orange-600 text-white disabled:opacity-50"
                        >
                        ...
                        <Button
                           ...
                           disabled={isAddToCartDisabled}
                           variant="outline"
                           className="w-full mt-3 h-10 text-sm font-medium text-brand-blue border border-brand-blue bg-transparent rounded-md hover:bg-brand-blue hover:text-white transition"
                        >
                           {t("products.buyNow")}
                        </Button>
                     </div>

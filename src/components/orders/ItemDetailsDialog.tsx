...
export const ItemDetailsDialog: React.FC<ItemDetailsDialogProps> = ({
  ...
  const customerName = `${item.order?.customer_first_name || ""} ${item.order?.customer_last_name || ""}`.trim() || "Unknown Customer";
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600">Product ID: {item.id || "N/A"}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">RWF {productPrice.toLocaleString()}</p>
                  </div>
                </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-lg">Refund Information</h3>
                <Badge className={getStatusColor(item.refund_status || "")}>
              ...
              <div className="space-y-3">
                ...
                {item.refund_reason && (
                  <div>
                    ...
                    <p className="font-semibold">{item.refund_reason}</p>
                  </div>
                )}
                ...
                <div>
                  ...
                  <p className="font-semibold text-lg text-orange-600">
                    RWF {(productPrice * (item.quantity || 1)).toLocaleString()}
                  </p>
                </div>
              </div>
            </CardContent>

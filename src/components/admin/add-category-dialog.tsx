...
import { fetchSubcategories, createSubcategory, updateSubcategory, deleteSubcategory } from '@/integrations/supabase/subcategories';
                ...
                {editingSubcategory && (
                  <div className="flex gap-2 mb-4">
                    <Input
                      ...
                      value={newSubcategoryName}
                      onChange={(e) => setNewSubcategoryName(e.target.value)}
                      onKeyPress={(e) => e.key === 'Enter' && handleEditSubcategory()}
                    />
                    <Button type="button" onClick={handleEditSubcategory} size="sm">
                      Save
                    </Button>
                    <Button
                      type="button"

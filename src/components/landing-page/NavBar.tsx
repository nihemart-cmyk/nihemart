          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                className={cn(!user ? "hidden md:inline-flex" : "inline-flex")}
              >
            ...
            <DropdownMenuContent align="end" className="z-[9999]">
              {!user ? (
                ...
                <>
                  <DropdownMenuItem asChild>
                    <Link href={"/about"} className="hidden lg:block">{t("nav.about")}</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href={"/profile"}>{t("nav.profile")}</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href={"/returns"} className="hidden lg:block">{t("nav.returns")}</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>

...
const MoreProducts: FC<MoreProductsProps> = ({ }) => {
    ...
    return <div>
        <MaxWidthWrapper size={'lg'} className=''>
            ...
            <div className="bg-brand-blue w-full my-20 text-white rounded-xl px-20 py-2 flex items-center justify-between gap-5">
        ...
        <MarqueeBanner />
        <MaxWidthWrapper size={'lg'} className="grid grid-cols-4 gap-5 mb-10">

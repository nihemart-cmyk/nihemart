            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-sky-200/50 p-10 border border-white/50">
               ...
               <div className="flex justify-center mb-6">
                  <div className="relative">
                     ...
                     {/* Animated rings */}
                     <div
                        className="absolute inset-0 w-24 h-24 rounded-full border-4 border-sky-300 opacity-50"
                        style={{
                           animation:
                     ...
                     />
                     <div
                        className="absolute inset-0 w-24 h-24 rounded-full border-4 border-orange-300 opacity-30"
                        style={{
                           animation:
                              "ping 1.5s cubic-bezier(0, 0, 0.2, 1) infinite",
                           animationDelay: "0.5s",
               ...
               <p className="text-gray-600 text-center mb-8 leading-relaxed">
                  {message || t("thankYou.defaultMessage")}
               </p>

               {/* Order confirmation visual */}
               <div className="bg-gradient-to-r from-sky-50 to-orange-50 rounded-2xl p-5 mb-8 border border-sky-100">
